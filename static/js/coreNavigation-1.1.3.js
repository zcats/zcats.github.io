        ...
        scrollSpy: function(n) {
            $(".scrollspy").each(function() {
                ...
                $(o).length && $(window).on("scroll", function() {
                    var t = void 0;
                    t = "section" == n.layout && $(window).width() > 920 ? $(o).offset().top : $(o).offset().top - parseInt(n.dataMinusOffset), $(window).scrollTop() > t - 1 || $(window).scrollTop() > t + 1 ? ($(".scrollspy").removeClass("active"), $(e).addClass("active")) : $(e).removeClass("active")
                }), $("a", this).on("click", function(e) {
                    e.preventDefault();
                    var t = $("html, body"),
                        a = void 0;
                    a = "section" == n.layout && $(window).width() > 920 ? $(o).offset().top + 1 : $(o).offset().top - parseInt($(o).css("padding-top")) / 2, t.stop().animate({
                        scrollTop: $(o).offset().top - n.dataMinusOffset
                    }, 500);
					$('nav.core-nav').removeClass("open-responsive open-dropdown");
                })
            })
        },
